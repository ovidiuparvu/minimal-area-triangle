...
namespace triangle {
    ...
    class Geometry2D {
        ...
        public:
             ...
             * \param b Point2d b
             */
            static double angleOfLineWrtOxAxis(const Point2d &a, const Point2d &b);
             ...
             */
            static bool slopeOfLine(const Point2d &a, const Point2d &b, double &slope);
             ...
             * \param b Point2d b
             */
            static double distanceBtwPoints(const Point2d &a, const Point2d &b);
             ...
             *
             * \param a             Point2d from which the distance is measures
             * \param linePointB    One of the points determining the line
             * \param linePointC    One of the points determining the line
             */
            static double distanceFromPointToLine(const Point2d &a, const Point2d &linePointB, const Point2d &linePointC);
             ...
             * \param b Point2d b
             */
            static Point2d middlePoint(const Point2d &a, const Point2d &b);
             ...
             */
            static bool areOnTheSameSideOfLine(const Point2d &p1, const Point2d &p2, const Point2d &a, const Point2d &b);
             ...
             */
            static void lineEquationDeterminedByPoints(const Point2d &p, const Point2d &q, double &a, double &b, double &c);
             ...
             * \param b2 Second point for determining the second line
             */
            static bool areIdenticalLines(const Point2d &a1, const Point2d &b1, const Point2d &a2, const Point2d &b2);
             ...
             */
            static bool lineIntersection(const Point2d &a1, const Point2d &b1, const Point2d &a2, const Point2d &b2, Point2d &intersection);
             ...
             * \param intersection The intersection point, if this point exists
             */
            static bool lineIntersection(double a1, double b1, double c1, double a2, double b2, double c2, Point2d &intersection);
             ...
             */
            static bool lineCircleIntersection(Point2d a, Point2d b, const Point2d &circleOrigin,
             ...
             * \param intersectionPoints    The intersection points between the circle and the line
             */
            static bool lineSegmentCircleIntersection(const Point2d &a, const Point2d &b, const Point2d &circleOrigin,
                                                      double radius, vector<Point2d> &intersectionPoints);
             ...
             * \param c Point2d c
             */
            static double angleBtwPoints(const Point2d &a, const Point2d &b, const Point2d &c);
             ...
             */
            static vector<Point2d> findPointsOnEdge(const vector<Point2d> &points, unsigned int nrOfRows, unsigned int nrOfCols);
             ...
             */
            static unsigned int minimumDistancePointIndex(const vector<Point> &points, const Point2d &origin);
             ...
             * \param c Point2d c
             */
            static double areaOfTriangle(const Point2d &a, const Point2d &b, const Point2d &c);
             ...
             */
            static bool isPointOnLineSegment(const Point2d &point, const Point2d &lineSegmentStart,
             ...
             */
            static bool areEqualPoints(const Point2d &point1, const Point2d &point2);
             ...
             */
            static bool areCollinear(const Point2d &point1, const Point2d &point2, const Point2d &point3);
        ...
        private:
             ...
             *  \param nrOfCols The number of columns
             */
            static bool isPointOnEdge(const Point2d &p, int nrOfRows, int nrOfCols);
             ...
             */
            static void translate(Point2d &point, const Point2d &translation);
             ...
             * \param translation Translation values
             */
            static void inverseTranslate(Point2d &point, const Point2d &translation);
             ...
             */
            static void lineCircleTwoIntersectionPoints(const Point2d &circleOrigin, double A, double B,
             ...
             * \param intersectionPoints    Intersection points
             */
            static void lineCircleOneIntersectionPoint(const Point2d &circleOrigin, double A, double B,
                                                       double C, double delta, vector<Point2d> &intersectionPoints);
